...
path_P_1 = fullfile(pwd,'..','simulate-input','data_P_xilanh_1.dat');
path_T_1 = fullfile(pwd,'..','simulate-input','data_T_xilanh_1.dat');
path_P_2 = fullfile(pwd,'..','simulate-input','data_P_xilanh_2.dat');
path_T_2 = fullfile(pwd,'..','simulate-input','data_T_xilanh_2.dat');
path_P_3 = fullfile(pwd,'..','simulate-input','data_P_xilanh_3.dat');
path_T_3 = fullfile(pwd,'..','simulate-input','data_T_xilanh_3.dat');
