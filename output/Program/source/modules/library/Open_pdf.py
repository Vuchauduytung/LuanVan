...
def open_c(main_path, compression_pressure, Pmax, Pmin, Minimum_load_pressure, minimum_pressure ):
...
def open_out(main_path, compression_pressure, Pmax, P_out,P_out_st,P_compress_end, Minimum_load_pressure, Minimum_charge_pressure ):
