...
for k = 540:580;
     ...
     T_value_1(k)=(Tc*((abs(pmin_1(k))/Pc)))+273;
end
for k = 581:721;
...
hold on 
path_P = fullfile(pwd,'..','output','Program','simulate-input','data_P_loi_2.dat');
path_T = fullfile(pwd,'..','output','Program','simulate-input','data_T_loi_2.dat');
cla;
